#ifndef PYBINDSTAN_SOCKET_LOGGER_HPP
#define PYBINDSTAN_SOCKET_LOGGER_HPP
...
/**
 * NOTE: pybindstan makes an unorthodox use of `message_prefix`!
 *
 * See discussion in pybindstan/socket_writer.hpp
 *
 */
...
#endif // PYBINDSTAN_SOCKET_LOGGER_HPP
